...
```bash
diesel migration generate name_of_the_migration
```

Diesel CLI will create two empty files for us in the required structure. You’ll see output that looks something like this:

```bash
Creating migrations/20160815133237_name_of_the_migration/up.sql
Creating migrations/20160815133237_name_of_the_migration/down.sql
```
